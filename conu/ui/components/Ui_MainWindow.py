...
"}")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, -308, 1358, 1270))
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_dteDateCompleted, 17, 1, 1, 4)
