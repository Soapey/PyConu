...
"    min-height: 200px;\n"
"}")
        self.workorder_entryform_tblUnassignedAssignees.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.workorder_entryform_tblUnassignedAssignees.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.workorder_entryform_tblUnassignedAssignees.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.workorder_entryform_tblUnassignedAssignees.horizontalHeader().setStretchLastSection(True)
        self.workorder_entryform_tblUnassignedAssignees.verticalHeader().setVisible(False)
        ...
        self.gridLayout_26.addWidget(self.label_68, 19, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblDepartment, 4, 1, 1, 2)
...
"    min-height: 200px;\n"
"}")
        self.workorder_entryform_tblAssignedAssignees.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.workorder_entryform_tblAssignedAssignees.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.workorder_entryform_tblAssignedAssignees.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.workorder_entryform_tblAssignedAssignees.horizontalHeader().setStretchLastSection(True)
        self.workorder_entryform_tblAssignedAssignees.verticalHeader().setVisible(False)
        self.gridLayout_26.addWidget(self.workorder_entryform_tblAssignedAssignees, 11, 2, 1, 1)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_btnUnassignItemFromWorkOrder, 7, 2, 1, 1)
...
"")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_txtPurchaseOrderNumber, 6, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblRaisedBy, 2, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblPriorityLevel, 5, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblSite, 3, 1, 1, 2)
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_chkIsComplete, 17, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_dteDateAllocated, 14, 1, 1, 2)
        ...
        self.gridLayout_26.addWidget(self.label_66, 18, 0, 1, 1)
...
"}")
        ...
        self.workorder_entryform_dteDateCompleted = QtWidgets.QDateEdit(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.workorder_entryform_dteDateCompleted.sizePolicy().hasHeightForWidth())
        self.workorder_entryform_dteDateCompleted.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.workorder_entryform_dteDateCompleted.setFont(font)
        self.workorder_entryform_dteDateCompleted.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.workorder_entryform_dteDateCompleted.setStyleSheet("QDateEdit {\n"
"    background-color: white;\n"
"    border-style: inset;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    border-color: #028090;\n"
"}")
        self.workorder_entryform_dteDateCompleted.setButtonSymbols(QtWidgets.QAbstractSpinBox.UpDownArrows)
        self.workorder_entryform_dteDateCompleted.setProperty("showGroupSeparator", False)
        self.workorder_entryform_dteDateCompleted.setCalendarPopup(True)
        self.workorder_entryform_dteDateCompleted.setObjectName("workorder_entryform_dteDateCompleted")
        self.gridLayout_26.addWidget(self.workorder_entryform_dteDateCompleted, 18, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_btnUnassignAssigneeFromWorkOrder, 10, 2, 1, 1)
...
"    min-height: 200px;\n"
"}")
        self.workorder_entryform_tblUnassignedItems.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.workorder_entryform_tblUnassignedItems.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.workorder_entryform_tblUnassignedItems.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.workorder_entryform_tblUnassignedItems.horizontalHeader().setStretchLastSection(True)
        self.workorder_entryform_tblUnassignedItems.verticalHeader().setVisible(False)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblId, 0, 1, 1, 2)
...
"")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_txtComments, 12, 1, 1, 2)
...
"")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_txtCloseOutComments, 19, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_lblDateCreated, 1, 1, 1, 2)
...
"    min-height: 200px;\n"
"}")
        self.workorder_entryform_tblAssignedItems.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.workorder_entryform_tblAssignedItems.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.workorder_entryform_tblAssignedItems.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.workorder_entryform_tblAssignedItems.horizontalHeader().setStretchLastSection(True)
        self.workorder_entryform_tblAssignedItems.verticalHeader().setVisible(False)
        self.gridLayout_26.addWidget(self.workorder_entryform_tblAssignedItems, 8, 2, 1, 1)
...
"")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_txtTaskDescription, 9, 1, 1, 2)
        self.workorder_entryform_lblCurrentUnits = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.workorder_entryform_lblCurrentUnits.setFont(font)
        self.workorder_entryform_lblCurrentUnits.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.workorder_entryform_lblCurrentUnits.setObjectName("workorder_entryform_lblCurrentUnits")
        self.gridLayout_26.addWidget(self.workorder_entryform_lblCurrentUnits, 16, 0, 1, 1)
        self.workorder_entryform_spnCurrentUnits = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.workorder_entryform_spnCurrentUnits.sizePolicy().hasHeightForWidth())
        self.workorder_entryform_spnCurrentUnits.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.workorder_entryform_spnCurrentUnits.setFont(font)
        self.workorder_entryform_spnCurrentUnits.setStyleSheet("QSpinBox {\n"
"    background-color: white;\n"
"    border-style: inset;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"}\n"
"")
        self.workorder_entryform_spnCurrentUnits.setMinimum(1)
        self.workorder_entryform_spnCurrentUnits.setMaximum(999999999)
        self.workorder_entryform_spnCurrentUnits.setObjectName("workorder_entryform_spnCurrentUnits")
        self.gridLayout_26.addWidget(self.workorder_entryform_spnCurrentUnits, 16, 1, 1, 2)
        self.workorder_entryform_lblCalibrationDate = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.workorder_entryform_lblCalibrationDate.setFont(font)
        self.workorder_entryform_lblCalibrationDate.setObjectName("workorder_entryform_lblCalibrationDate")
        self.gridLayout_26.addWidget(self.workorder_entryform_lblCalibrationDate, 15, 0, 1, 1)
        self.workorder_entryform_dteCalibrationDate = QtWidgets.QDateEdit(self.scrollAreaWidgetContents_4)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.workorder_entryform_dteCalibrationDate.setFont(font)
        self.workorder_entryform_dteCalibrationDate.setStyleSheet("QDateEdit {\n"
"    background-color: white;\n"
"    border-style: inset;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    border-color: #028090;\n"
"}")
        self.workorder_entryform_dteCalibrationDate.setCalendarPopup(True)
        self.workorder_entryform_dteCalibrationDate.setObjectName("workorder_entryform_dteCalibrationDate")
        self.gridLayout_26.addWidget(self.workorder_entryform_dteCalibrationDate, 15, 1, 1, 2)
...
"}")
        ...
        self.recurringworkorder_entryform_page_handler = QtWidgets.QStackedWidget(self.groupBox)
        self.recurringworkorder_entryform_page_handler.setStyleSheet("")
        self.recurringworkorder_entryform_page_handler.setObjectName("recurringworkorder_entryform_page_handler")
        self.recurringworkorder_entryform_pageDaily = QtWidgets.QWidget()
        self.recurringworkorder_entryform_pageDaily.setObjectName("recurringworkorder_entryform_pageDaily")
        self.gridLayout_33 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_pageDaily)
        self.gridLayout_33.setObjectName("gridLayout_33")
        self.recurringworkorder_entryform_daily_groupOption2 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageDaily)
        self.recurringworkorder_entryform_daily_groupOption2.setStyleSheet("min-height: 20px;")
        self.recurringworkorder_entryform_daily_groupOption2.setObjectName("recurringworkorder_entryform_daily_groupOption2")
        self.gridLayout_35 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_daily_groupOption2)
        self.gridLayout_35.setObjectName("gridLayout_35")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.recurringworkorder_entryform_daily_radOption2 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_daily_groupOption2)
        self.recurringworkorder_entryform_daily_radOption2.setObjectName("recurringworkorder_entryform_daily_radOption2")
        self.horizontalLayout_3.addWidget(self.recurringworkorder_entryform_daily_radOption2)
        self.gridLayout_35.addLayout(self.horizontalLayout_3, 0, 0, 1, 1)
        self.gridLayout_33.addWidget(self.recurringworkorder_entryform_daily_groupOption2, 3, 0, 1, 2)
        self.recurringworkorder_entryform__daily_groupOption1 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageDaily)
        self.recurringworkorder_entryform__daily_groupOption1.setEnabled(True)
        self.recurringworkorder_entryform__daily_groupOption1.setStyleSheet("")
        self.recurringworkorder_entryform__daily_groupOption1.setObjectName("recurringworkorder_entryform__daily_groupOption1")
        self.gridLayout_34 = QtWidgets.QGridLayout(self.recurringworkorder_entryform__daily_groupOption1)
        self.gridLayout_34.setObjectName("gridLayout_34")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.recurringworkorder_entryform_daily_radOption1 = QtWidgets.QRadioButton(self.recurringworkorder_entryform__daily_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_daily_radOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_daily_radOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_daily_radOption1.setObjectName("recurringworkorder_entryform_daily_radOption1")
        self.horizontalLayout_2.addWidget(self.recurringworkorder_entryform_daily_radOption1)
        self.recurringworkorder_entryform_daily_spnOption1 = QtWidgets.QSpinBox(self.recurringworkorder_entryform__daily_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_daily_spnOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_daily_spnOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_daily_spnOption1.setMinimum(1)
        self.recurringworkorder_entryform_daily_spnOption1.setMaximum(999)
        self.recurringworkorder_entryform_daily_spnOption1.setObjectName("recurringworkorder_entryform_daily_spnOption1")
        self.horizontalLayout_2.addWidget(self.recurringworkorder_entryform_daily_spnOption1)
        self.recurringworkorder_entryform__daily_lblOption1 = QtWidgets.QLabel(self.recurringworkorder_entryform__daily_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform__daily_lblOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform__daily_lblOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform__daily_lblOption1.setObjectName("recurringworkorder_entryform__daily_lblOption1")
        self.horizontalLayout_2.addWidget(self.recurringworkorder_entryform__daily_lblOption1)
        self.gridLayout_34.addLayout(self.horizontalLayout_2, 0, 0, 1, 1)
        self.gridLayout_33.addWidget(self.recurringworkorder_entryform__daily_groupOption1, 2, 0, 1, 2)
        self.recurringworkorder_entryform_page_handler.addWidget(self.recurringworkorder_entryform_pageDaily)
        self.recurringworkorder_entryform_pageWeekly = QtWidgets.QWidget()
        self.recurringworkorder_entryform_pageWeekly.setObjectName("recurringworkorder_entryform_pageWeekly")
        self.gridLayout_36 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_pageWeekly)
        self.gridLayout_36.setObjectName("gridLayout_36")
        self.recurringworkorder_entryform_weekly_groupOption1 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageWeekly)
        self.recurringworkorder_entryform_weekly_groupOption1.setObjectName("recurringworkorder_entryform_weekly_groupOption1")
        self.gridLayout_37 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_weekly_groupOption1)
        self.gridLayout_37.setObjectName("gridLayout_37")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.recurringworkorder_entryform_weekly_radOption1 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_weekly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_weekly_radOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_weekly_radOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_weekly_radOption1.setObjectName("recurringworkorder_entryform_weekly_radOption1")
        self.horizontalLayout.addWidget(self.recurringworkorder_entryform_weekly_radOption1)
        self.recurringworkorder_entryform_weekly_spnOption1 = QtWidgets.QSpinBox(self.recurringworkorder_entryform_weekly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_weekly_spnOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_weekly_spnOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_weekly_spnOption1.setMinimum(1)
        self.recurringworkorder_entryform_weekly_spnOption1.setMaximum(52)
        self.recurringworkorder_entryform_weekly_spnOption1.setObjectName("recurringworkorder_entryform_weekly_spnOption1")
        self.horizontalLayout.addWidget(self.recurringworkorder_entryform_weekly_spnOption1)
        self.recurringworkorder_entryform_weekly_lblOption1 = QtWidgets.QLabel(self.recurringworkorder_entryform_weekly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_weekly_lblOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_weekly_lblOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_weekly_lblOption1.setObjectName("recurringworkorder_entryform_weekly_lblOption1")
        self.horizontalLayout.addWidget(self.recurringworkorder_entryform_weekly_lblOption1)
        self.gridLayout_37.addLayout(self.horizontalLayout, 0, 0, 1, 1)
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays = QtWidgets.QGridLayout()
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.setObjectName("recurringworkorder_entryform_weekly_grdOption1_weekdays")
        self.recurringworkorder_entryform_weekly_chkOption1_monday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_monday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_monday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_monday, 0, 0, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_tuesday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_tuesday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_tuesday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_tuesday, 0, 1, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_wednesday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_wednesday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_wednesday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_wednesday, 0, 2, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_thursday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_thursday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_thursday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_thursday, 0, 3, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_friday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_friday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_friday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_friday, 1, 0, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_saturday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_saturday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_saturday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_saturday, 1, 1, 1, 1)
        self.recurringworkorder_entryform_weekly_chkOption1_sunday = QtWidgets.QCheckBox(self.recurringworkorder_entryform_weekly_groupOption1)
        self.recurringworkorder_entryform_weekly_chkOption1_sunday.setObjectName("recurringworkorder_entryform_weekly_chkOption1_sunday")
        self.recurringworkorder_entryform_weekly_grdOption1_weekdays.addWidget(self.recurringworkorder_entryform_weekly_chkOption1_sunday, 1, 2, 1, 1)
        self.gridLayout_37.addLayout(self.recurringworkorder_entryform_weekly_grdOption1_weekdays, 1, 0, 1, 1)
        self.gridLayout_36.addWidget(self.recurringworkorder_entryform_weekly_groupOption1, 0, 0, 1, 1)
        self.recurringworkorder_entryform_page_handler.addWidget(self.recurringworkorder_entryform_pageWeekly)
        self.recurringworkorder_entryform_pageMonthly = QtWidgets.QWidget()
        self.recurringworkorder_entryform_pageMonthly.setObjectName("recurringworkorder_entryform_pageMonthly")
        self.gridLayout_39 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_pageMonthly)
        self.gridLayout_39.setObjectName("gridLayout_39")
        self.recurringworkorder_entryform_monthly_groupOption1 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageMonthly)
        self.recurringworkorder_entryform_monthly_groupOption1.setObjectName("recurringworkorder_entryform_monthly_groupOption1")
        self.gridLayout_40 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_monthly_groupOption1)
        self.gridLayout_40.setObjectName("gridLayout_40")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.recurringworkorder_entryform_monthly_radOption1 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_monthly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_radOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_radOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_radOption1.setObjectName("recurringworkorder_entryform_monthly_radOption1")
        self.horizontalLayout_4.addWidget(self.recurringworkorder_entryform_monthly_radOption1)
        self.recurringworkorder_entryform_monthly_spnOption1_day = QtWidgets.QSpinBox(self.recurringworkorder_entryform_monthly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_spnOption1_day.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_spnOption1_day.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_spnOption1_day.setMinimum(1)
        self.recurringworkorder_entryform_monthly_spnOption1_day.setMaximum(31)
        self.recurringworkorder_entryform_monthly_spnOption1_day.setObjectName("recurringworkorder_entryform_monthly_spnOption1_day")
        self.horizontalLayout_4.addWidget(self.recurringworkorder_entryform_monthly_spnOption1_day)
        self.recurringworkorder_entryform_monthly_lblOption1 = QtWidgets.QLabel(self.recurringworkorder_entryform_monthly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_lblOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_lblOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_lblOption1.setObjectName("recurringworkorder_entryform_monthly_lblOption1")
        self.horizontalLayout_4.addWidget(self.recurringworkorder_entryform_monthly_lblOption1)
        self.recurringworkorder_entryform_monthly_spnOption1_month = QtWidgets.QSpinBox(self.recurringworkorder_entryform_monthly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_spnOption1_month.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_spnOption1_month.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_spnOption1_month.setMinimum(1)
        self.recurringworkorder_entryform_monthly_spnOption1_month.setMaximum(999)
        self.recurringworkorder_entryform_monthly_spnOption1_month.setObjectName("recurringworkorder_entryform_monthly_spnOption1_month")
        self.horizontalLayout_4.addWidget(self.recurringworkorder_entryform_monthly_spnOption1_month)
        self.recurringworkorder_entryform_monthly_lblOption1_2 = QtWidgets.QLabel(self.recurringworkorder_entryform_monthly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_lblOption1_2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_lblOption1_2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_lblOption1_2.setObjectName("recurringworkorder_entryform_monthly_lblOption1_2")
        self.horizontalLayout_4.addWidget(self.recurringworkorder_entryform_monthly_lblOption1_2)
        self.gridLayout_40.addLayout(self.horizontalLayout_4, 0, 0, 1, 1)
        self.gridLayout_39.addWidget(self.recurringworkorder_entryform_monthly_groupOption1, 0, 0, 1, 1)
        self.recurringworkorder_entryform_monthly_groupOption2 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageMonthly)
        self.recurringworkorder_entryform_monthly_groupOption2.setObjectName("recurringworkorder_entryform_monthly_groupOption2")
        self.gridLayout_41 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_monthly_groupOption2)
        self.gridLayout_41.setObjectName("gridLayout_41")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.recurringworkorder_entryform_monthly_radOption2 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_radOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_radOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_radOption2.setObjectName("recurringworkorder_entryform_monthly_radOption2")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_monthly_radOption2)
        self.recurringworkorder_entryform_monthly_cmbOption2_occurrence = QtWidgets.QComboBox(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_monthly_cmbOption2_occurrence.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_monthly_cmbOption2_occurrence.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_monthly_cmbOption2_occurrence.setObjectName("recurringworkorder_entryform_monthly_cmbOption2_occurrence")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_monthly_cmbOption2_occurrence)
        self.recurringworkorder_entryform_cmbOption2_weekday = QtWidgets.QComboBox(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_cmbOption2_weekday.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_cmbOption2_weekday.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_cmbOption2_weekday.setObjectName("recurringworkorder_entryform_cmbOption2_weekday")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_cmbOption2_weekday)
        self.recurringworkorder_entryform_lblOption2 = QtWidgets.QLabel(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_lblOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_lblOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_lblOption2.setObjectName("recurringworkorder_entryform_lblOption2")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_lblOption2)
        self.recurringworkorder_entryform_spnOption2 = QtWidgets.QSpinBox(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_spnOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_spnOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_spnOption2.setMinimum(1)
        self.recurringworkorder_entryform_spnOption2.setMaximum(999)
        self.recurringworkorder_entryform_spnOption2.setObjectName("recurringworkorder_entryform_spnOption2")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_spnOption2)
        self.recurringworkorder_entryform_lblOption2_2 = QtWidgets.QLabel(self.recurringworkorder_entryform_monthly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_lblOption2_2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_lblOption2_2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_lblOption2_2.setObjectName("recurringworkorder_entryform_lblOption2_2")
        self.horizontalLayout_5.addWidget(self.recurringworkorder_entryform_lblOption2_2)
        self.gridLayout_41.addLayout(self.horizontalLayout_5, 0, 0, 1, 1)
        self.gridLayout_39.addWidget(self.recurringworkorder_entryform_monthly_groupOption2, 1, 0, 1, 1)
        self.recurringworkorder_entryform_page_handler.addWidget(self.recurringworkorder_entryform_pageMonthly)
        self.recurringworkorder_entryform_pageYearly = QtWidgets.QWidget()
        self.recurringworkorder_entryform_pageYearly.setObjectName("recurringworkorder_entryform_pageYearly")
        self.gridLayout_42 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_pageYearly)
        self.gridLayout_42.setObjectName("gridLayout_42")
        self.recurringworkorder_entryform_yearly_groupOption1 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageYearly)
        self.recurringworkorder_entryform_yearly_groupOption1.setObjectName("recurringworkorder_entryform_yearly_groupOption1")
        self.gridLayout_43 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_yearly_groupOption1)
        self.gridLayout_43.setObjectName("gridLayout_43")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.recurringworkorder_entryform_yearly_radOption1 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_yearly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_radOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_radOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_radOption1.setObjectName("recurringworkorder_entryform_yearly_radOption1")
        self.horizontalLayout_6.addWidget(self.recurringworkorder_entryform_yearly_radOption1)
        self.recurringworkorder_entryform_yearly_spnOption1_year = QtWidgets.QSpinBox(self.recurringworkorder_entryform_yearly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_spnOption1_year.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_spnOption1_year.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_spnOption1_year.setMinimum(1)
        self.recurringworkorder_entryform_yearly_spnOption1_year.setMaximum(999)
        self.recurringworkorder_entryform_yearly_spnOption1_year.setObjectName("recurringworkorder_entryform_yearly_spnOption1_year")
        self.horizontalLayout_6.addWidget(self.recurringworkorder_entryform_yearly_spnOption1_year)
        self.recurringworkorder_entryform_yearly_lblOption1 = QtWidgets.QLabel(self.recurringworkorder_entryform_yearly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_lblOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_lblOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_lblOption1.setObjectName("recurringworkorder_entryform_yearly_lblOption1")
        self.horizontalLayout_6.addWidget(self.recurringworkorder_entryform_yearly_lblOption1)
        self.recurringworkorder_entryform_yearly_cmbOption1 = QtWidgets.QComboBox(self.recurringworkorder_entryform_yearly_groupOption1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_cmbOption1.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_cmbOption1.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_cmbOption1.setObjectName("recurringworkorder_entryform_yearly_cmbOption1")
        self.horizontalLayout_6.addWidget(self.recurringworkorder_entryform_yearly_cmbOption1)
        self.recurringworkorder_entryform_yearly_spnOption1_day = QtWidgets.QSpinBox(self.recurringworkorder_entryform_yearly_groupOption1)
        self.recurringworkorder_entryform_yearly_spnOption1_day.setMinimum(1)
        self.recurringworkorder_entryform_yearly_spnOption1_day.setMaximum(31)
        self.recurringworkorder_entryform_yearly_spnOption1_day.setObjectName("recurringworkorder_entryform_yearly_spnOption1_day")
        self.horizontalLayout_6.addWidget(self.recurringworkorder_entryform_yearly_spnOption1_day)
        spacerItem17 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_6.addItem(spacerItem17)
        self.gridLayout_43.addLayout(self.horizontalLayout_6, 0, 0, 1, 1)
        self.gridLayout_42.addWidget(self.recurringworkorder_entryform_yearly_groupOption1, 0, 0, 1, 1)
        self.recurringworkorder_entryform_yearly_groupOption2 = QtWidgets.QGroupBox(self.recurringworkorder_entryform_pageYearly)
        self.recurringworkorder_entryform_yearly_groupOption2.setObjectName("recurringworkorder_entryform_yearly_groupOption2")
        self.gridLayout_44 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_yearly_groupOption2)
        self.gridLayout_44.setObjectName("gridLayout_44")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.recurringworkorder_entryform_yearly_radOption2 = QtWidgets.QRadioButton(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_radOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_radOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_radOption2.setObjectName("recurringworkorder_entryform_yearly_radOption2")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_radOption2)
        self.recurringworkorder_entryform_yearly_spnOption2 = QtWidgets.QSpinBox(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_spnOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_spnOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_spnOption2.setMinimum(1)
        self.recurringworkorder_entryform_yearly_spnOption2.setMaximum(999)
        self.recurringworkorder_entryform_yearly_spnOption2.setObjectName("recurringworkorder_entryform_yearly_spnOption2")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_spnOption2)
        self.recurringworkorder_entryform_yearly_lblOption2 = QtWidgets.QLabel(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_lblOption2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_lblOption2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_lblOption2.setObjectName("recurringworkorder_entryform_yearly_lblOption2")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_lblOption2)
        self.recurringworkorder_entryform_yearly_cmbOption2_occurrence = QtWidgets.QComboBox(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_cmbOption2_occurrence.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_cmbOption2_occurrence.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_cmbOption2_occurrence.setObjectName("recurringworkorder_entryform_yearly_cmbOption2_occurrence")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_cmbOption2_occurrence)
        self.recurringworkorder_entryform_yearly_cmbOption2_weekday = QtWidgets.QComboBox(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_cmbOption2_weekday.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_cmbOption2_weekday.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_cmbOption2_weekday.setObjectName("recurringworkorder_entryform_yearly_cmbOption2_weekday")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_cmbOption2_weekday)
        self.recurringworkorder_entryform_yearly_lblOption2_2 = QtWidgets.QLabel(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_lblOption2_2.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_lblOption2_2.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_lblOption2_2.setObjectName("recurringworkorder_entryform_yearly_lblOption2_2")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_lblOption2_2)
        self.recurringworkorder_entryform_yearly_cmbOption2_month = QtWidgets.QComboBox(self.recurringworkorder_entryform_yearly_groupOption2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_yearly_cmbOption2_month.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_yearly_cmbOption2_month.setSizePolicy(sizePolicy)
        self.recurringworkorder_entryform_yearly_cmbOption2_month.setObjectName("recurringworkorder_entryform_yearly_cmbOption2_month")
        self.horizontalLayout_7.addWidget(self.recurringworkorder_entryform_yearly_cmbOption2_month)
        spacerItem18 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem18)
        self.gridLayout_44.addLayout(self.horizontalLayout_7, 0, 0, 1, 1)
        self.gridLayout_42.addWidget(self.recurringworkorder_entryform_yearly_groupOption2, 1, 0, 1, 1)
        self.recurringworkorder_entryform_page_handler.addWidget(self.recurringworkorder_entryform_pageYearly)
        self.gridLayout_31.addWidget(self.recurringworkorder_entryform_page_handler, 0, 1, 1, 1)
...
"}")
        ...
        self.recurringworkorder_entryform_fmeSideMenu = QtWidgets.QFrame(self.groupBox_2)
        self.recurringworkorder_entryform_fmeSideMenu.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.recurringworkorder_entryform_fmeSideMenu.setFrameShadow(QtWidgets.QFrame.Raised)
        self.recurringworkorder_entryform_fmeSideMenu.setObjectName("recurringworkorder_entryform_fmeSideMenu")
        self.gridLayout_32 = QtWidgets.QGridLayout(self.recurringworkorder_entryform_fmeSideMenu)
        ...
        self.recurringworkorder_entryform_radDaily = QtWidgets.QRadioButton(self.recurringworkorder_entryform_fmeSideMenu)
        self.recurringworkorder_entryform_radDaily.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.recurringworkorder_entryform_radDaily.setStyleSheet("")
        self.recurringworkorder_entryform_radDaily.setChecked(True)
        self.recurringworkorder_entryform_radDaily.setObjectName("recurringworkorder_entryform_radDaily")
        self.verticalLayout.addWidget(self.recurringworkorder_entryform_radDaily)
        self.recurringworkorder_entryform_radWeekly = QtWidgets.QRadioButton(self.recurringworkorder_entryform_fmeSideMenu)
        self.recurringworkorder_entryform_radWeekly.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.recurringworkorder_entryform_radWeekly.setObjectName("recurringworkorder_entryform_radWeekly")
        self.verticalLayout.addWidget(self.recurringworkorder_entryform_radWeekly)
        self.recurringworkorder_entryform_radMonthly = QtWidgets.QRadioButton(self.recurringworkorder_entryform_fmeSideMenu)
        self.recurringworkorder_entryform_radMonthly.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.recurringworkorder_entryform_radMonthly.setObjectName("recurringworkorder_entryform_radMonthly")
        self.verticalLayout.addWidget(self.recurringworkorder_entryform_radMonthly)
        self.recurringworkorder_entryform_radYearly = QtWidgets.QRadioButton(self.recurringworkorder_entryform_fmeSideMenu)
        self.recurringworkorder_entryform_radYearly.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.recurringworkorder_entryform_radYearly.setObjectName("recurringworkorder_entryform_radYearly")
        self.verticalLayout.addWidget(self.recurringworkorder_entryform_radYearly)
        spacerItem19 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem19)
        self.gridLayout_32.addLayout(self.verticalLayout, 0, 0, 1, 1)
        self.gridLayout_30.addWidget(self.recurringworkorder_entryform_fmeSideMenu, 1, 0, 1, 1)
        self.gridLayout_31.addWidget(self.groupBox_2, 0, 0, 1, 1)
        self.gridLayout_28.addWidget(self.groupBox, 10, 1, 1, 2)
...
"}")
        ...
        self.recurringworkorder_entryform_lblLastRaisedDate = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recurringworkorder_entryform_lblLastRaisedDate.sizePolicy().hasHeightForWidth())
        self.recurringworkorder_entryform_lblLastRaisedDate.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.recurringworkorder_entryform_lblLastRaisedDate.setFont(font)
        self.recurringworkorder_entryform_lblLastRaisedDate.setStyleSheet("QLabel {\n"
"    background-color: lightgrey;\n"
"    border-style: inset;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"    padding: 4px;\n"
"}")
        self.recurringworkorder_entryform_lblLastRaisedDate.setText("")
        self.recurringworkorder_entryform_lblLastRaisedDate.setObjectName("recurringworkorder_entryform_lblLastRaisedDate")
        self.gridLayout_28.addWidget(self.recurringworkorder_entryform_lblLastRaisedDate, 1, 1, 1, 2)
...
"}")
        ...
        self.label_69 = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout_28.addWidget(self.label_69, 9, 0, 1, 1)
        self.recurringworkorder_entryform_dteStartDate = QtWidgets.QDateEdit(self.scrollAreaWidgetContents_5)
        self.recurringworkorder_entryform_dteStartDate.setStyleSheet("QDateEdit {\n"
"    background-color: white;\n"
"    border-style: inset;\n"
"    border-width: 1px;\n"
"    border-radius: 5px;\n"
...
"}\n"
"")
        self.recurringworkorder_entryform_dteStartDate.setCalendarPopup(True)
        self.recurringworkorder_entryform_dteStartDate.setObjectName("recurringworkorder_entryform_dteStartDate")
        self.gridLayout_28.addWidget(self.recurringworkorder_entryform_dteStartDate, 9, 1, 1, 2)
...
"}")
        ...
        spacerItem20 = QtWidgets.QSpacerItem(1159, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_29.addItem(spacerItem20, 2, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.workorder_entryform_tblUnassignedAssignees.setSortingEnabled(True)
        ...
        self.workorder_entryform_tblAssignedAssignees.setSortingEnabled(True)
        ...
        self.workorder_entryform_tblAssignedItems.setSortingEnabled(True)
        ...
        self.recurringworkorder_entryform_daily_groupOption2.setTitle(_translate("MainWindow", "Option 2"))
        self.recurringworkorder_entryform_daily_radOption2.setText(_translate("MainWindow", "Every weekday"))
        self.recurringworkorder_entryform__daily_groupOption1.setTitle(_translate("MainWindow", "Option 1"))
        self.recurringworkorder_entryform_daily_radOption1.setText(_translate("MainWindow", "Every"))
        self.recurringworkorder_entryform__daily_lblOption1.setText(_translate("MainWindow", "days"))
        self.recurringworkorder_entryform_weekly_groupOption1.setTitle(_translate("MainWindow", "Option1"))
        self.recurringworkorder_entryform_weekly_radOption1.setText(_translate("MainWindow", "Recur every"))
        self.recurringworkorder_entryform_weekly_lblOption1.setText(_translate("MainWindow", "week(s) on:"))
        self.recurringworkorder_entryform_weekly_chkOption1_monday.setText(_translate("MainWindow", "Monday"))
        self.recurringworkorder_entryform_weekly_chkOption1_tuesday.setText(_translate("MainWindow", "Tuesday"))
        self.recurringworkorder_entryform_weekly_chkOption1_wednesday.setText(_translate("MainWindow", "Wednesday"))
        self.recurringworkorder_entryform_weekly_chkOption1_thursday.setText(_translate("MainWindow", "Thursday"))
        self.recurringworkorder_entryform_weekly_chkOption1_friday.setText(_translate("MainWindow", "Friday"))
        self.recurringworkorder_entryform_weekly_chkOption1_saturday.setText(_translate("MainWindow", "Saturday"))
        self.recurringworkorder_entryform_weekly_chkOption1_sunday.setText(_translate("MainWindow", "Sunday"))
        self.recurringworkorder_entryform_monthly_groupOption1.setTitle(_translate("MainWindow", "Option 1"))
        self.recurringworkorder_entryform_monthly_radOption1.setText(_translate("MainWindow", "Day"))
        self.recurringworkorder_entryform_monthly_lblOption1.setText(_translate("MainWindow", "of every"))
        self.recurringworkorder_entryform_monthly_lblOption1_2.setText(_translate("MainWindow", "month(s)"))
        self.recurringworkorder_entryform_monthly_groupOption2.setTitle(_translate("MainWindow", "Option 2"))
        self.recurringworkorder_entryform_monthly_radOption2.setText(_translate("MainWindow", "The"))
        self.recurringworkorder_entryform_lblOption2.setText(_translate("MainWindow", "of every"))
        self.recurringworkorder_entryform_lblOption2_2.setText(_translate("MainWindow", "month(s)"))
        self.recurringworkorder_entryform_yearly_groupOption1.setTitle(_translate("MainWindow", "Option 1"))
        self.recurringworkorder_entryform_yearly_radOption1.setText(_translate("MainWindow", "Recur every"))
        self.recurringworkorder_entryform_yearly_lblOption1.setText(_translate("MainWindow", "year(s) on"))
        self.recurringworkorder_entryform_yearly_groupOption2.setTitle(_translate("MainWindow", "Option 2"))
        self.recurringworkorder_entryform_yearly_radOption2.setText(_translate("MainWindow", "Recur every"))
        self.recurringworkorder_entryform_yearly_lblOption2.setText(_translate("MainWindow", "year(s) on the"))
        self.recurringworkorder_entryform_yearly_lblOption2_2.setText(_translate("MainWindow", "of"))
        self.recurringworkorder_entryform_radDaily.setText(_translate("MainWindow", "Daily"))
        self.recurringworkorder_entryform_radWeekly.setText(_translate("MainWindow", "Weekly"))
        self.recurringworkorder_entryform_radMonthly.setText(_translate("MainWindow", "Monthly"))
        self.recurringworkorder_entryform_radYearly.setText(_translate("MainWindow", "Yearly"))
