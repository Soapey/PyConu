...
"}")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_dteDateCompleted, 17, 1, 1, 2)
...
"")
        ...
        self.gridLayout_26.addWidget(self.workorder_entryform_txtCloseOutComments, 18, 1, 1, 2)
