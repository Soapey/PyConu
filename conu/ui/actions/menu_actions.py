...
def connect_menu_actions(main_window):
    ...
    main_window.ui.action_logout.triggered.connect(lambda: main_window.login_window.log_out_user())
    ...
    main_window.ui.action_sites.triggered.connect(lambda: load_site_listingview(main_window))